...
-  `Exercise 02 : Initiator and Target
   Sockets <https://courses.edaplayground.com/x/4Vu_>`__

-  `Exercise 03 : Temporal
   Decoupling <https://courses.edaplayground.com/x/2Pru>`__

-  `Exercise 04 : Bursts, Streaming and Byte
   Enables <https://courses.edaplayground.com/x/2zhi>`__

-  `Exercise 05 : nb_transport <https://courses.edaplayground.com/x/yEP>`__

-  `Exercise 06 : Convenience
   Sockets <https://courses.edaplayground.com/x/3LU3>`__

-  `Exercise 07 : Transport Debug and
   DMI <https://courses.edaplayground.com/x/2grK>`__

-  `Exercise 08 : Generic Payload
   Extensions <https://courses.edaplayground.com/x/63fW>`__

-  `Exercise 09 : Width Conversion, Endianess &
   Protocols <https://courses.edaplayground.com/x/5Bj3>`__

-  `Exercise 09-2 : Width Conversion and
   Endianess <https://courses.edaplayground.com/x/35gw>`__

-  `Exercise 10 : New Protocols, DMI,
   Extensions <https://courses.edaplayground.com/x/5Htv>`__

-  `Exercise 11 : Analysis Ports <https://courses.edaplayground.com/x/4KnZ>`__

-  `Exercise 12-1 : TLM-1.0 Request-Response Channels (part
   1) <https://courses.edaplayground.com/x/5ceR>`__

-  `Exercise 12-2 : TLM-1.0 Request-Response Channels (part
   2) <https://courses.edaplayground.com/x/3MPf>`__
