...
`Exercise 1 <http://courses.edaplayground.com/x/7bq>`_

`Exercise 2 <http://courses.edaplayground.com/x/QEC>`_

`Exercise 3 <http://courses.edaplayground.com/x/M9k>`_

`Exercise 4 <http://courses.edaplayground.com/x/J5K>`_

`Exercise 5 <http://courses.edaplayground.com/x/BvS>`_

`Exercise 6 <http://courses.edaplayground.com/x/8r_>`_

`Exercise 7 <http://courses.edaplayground.com/x/5kZ>`_

`Exercise 8 <http://courses.edaplayground.com/x/Wze>`_

`Exercise 9 <http://courses.edaplayground.com/x/W5X>`_

`Exercise 10 <http://courses.edaplayground.com/x/T_6>`_

`Exercise 11 <http://courses.edaplayground.com/x/LrD>`_
